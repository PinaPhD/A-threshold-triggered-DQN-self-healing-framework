...
class MyTopo(Topo):
    def build(self):
        ...
        #Connecting the LDAQ to the WT access network
        linkopts = dict(bw=100, delay='0.05ms', loss=0.05, use_htb=True)
        self.addLink(ldaqwt1, wt1_sw1, **linkopts)
        self.addLink(ldaqwt2, wt1_sw2, **linkopts)
        self.addLink(ldaqwt3, wt1_sw3, **linkopts)
        self.addLink(ldaqwt4, wt1_sw4, **linkopts)
        self.addLink(ldaqwt5, wt1_sw5, **linkopts)
        
        #Connecting the WT nacelle switch to the tower switches
        ...
        '''
        Creating the spine-leaf topology at the OSS
        WT Tower switches connect to a spine layer switches
        Spine layer switches connect to distribution and access leaf switches
        '''
        
        #Connecting the WT tower switch to the spine switches
        ...
        #Connecting the spine switches with the core switch
        ...
        #Connecting the spine switches to the distribution leaf switches
        self.addLink(sp1, dlf1, **linkopts)
        self.addLink(sp1, dlf2, **linkopts)
        self.addLink(sp1, dlf3, **linkopts)
        self.addLink(sp1, dlf4, **linkopts)
        self.addLink(sp1, dlf5, **linkopts)
        
        self.addLink(sp2, dlf1, **linkopts)
        self.addLink(sp2, dlf2, **linkopts)
        self.addLink(sp2, dlf3, **linkopts)
        self.addLink(sp2, dlf4, **linkopts)
        self.addLink(sp2, dlf5, **linkopts)
        
        self.addLink(sp3, dlf1, **linkopts)
        self.addLink(sp3, dlf2, **linkopts)
        self.addLink(sp3, dlf3, **linkopts)
        self.addLink(sp3, dlf4, **linkopts)
        self.addLink(sp3, dlf5, **linkopts)
        
        self.addLink(sp4, dlf1, **linkopts)
        self.addLink(sp4, dlf2, **linkopts)
        self.addLink(sp4, dlf3, **linkopts)
        self.addLink(sp4, dlf4, **linkopts)
        self.addLink(sp4, dlf5, **linkopts)
        
        self.addLink(sp5, dlf1, **linkopts)
        self.addLink(sp5, dlf2, **linkopts)
        self.addLink(sp5, dlf3, **linkopts)
        self.addLink(sp5, dlf4, **linkopts)
        self.addLink(sp5, dlf5, **linkopts)
        
        #Connecting the distribution to access leaf switches
        ...
        #Connecting MU,ECP,vIED to the ALF switches
